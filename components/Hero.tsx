      ...
      >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <button onClick={() => setShowVideo(true)} className="group flex items-center justify-center gap-1.5 px-2 py-3.5 text-base text-[#111111] dark:text-slate-300 hover:text-[#666666] dark:hover:text-white transition-all duration-300 cursor-pointer">
              View Live Demo
